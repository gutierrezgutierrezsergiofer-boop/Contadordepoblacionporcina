...
def render_caseta(caseta):
    ...
    # Definir las unidades: (id, tipo)
    # Orden visual: E1 | E2  arriba, luego pares (1,2), (3,4), ..., (15,16)
    filas = [("E1", "E2")]
    for fila in range(8):
    ...
    <div style="display:flex; justify-content:center; padding:10px;
                background:#eaf4fb; border-radius:12px; border:1px solid #b0c4de;">
    ...
    for izq_id, der_id in filas:
        ...
        # Enfermerías: mitad de ancho. Corrales: ancho completo.
        ...
        html += f"""
        <tr>
          <td style="width:{ancho}; min-width:{ancho}; height:{alto};
                     background:#c9dff0; border:1px solid #7a9cbf;
                     border-radius:4px; text-align:center; vertical-align:middle;
                     padding:6px; font-size:12px; color:#1a3d5c;">
            <b>{uid_izq}</b><br><span style="font-size:16px;">{pob_izq}</span>
          </td>
          ...
          <td style="width:{ancho}; min-width:{ancho}; height:{alto};
                     ...
                     border-radius:4px; text-align:center; vertical-align:middle;
                     padding:6px; font-size:12px; color:#1a3d5c;">
            <b>{uid_der}</b><br><span style="font-size:16px;">{pob_der}</span>
          </td>
        </tr>
        """
    html += """
    ...
    # Los botones de edición van aparte, en un expander por caseta
    with st.expander(f"✏️ Editar corrales de Caseta {caseta}"):
        ...
        # Mostrar editor para el corral seleccionado
